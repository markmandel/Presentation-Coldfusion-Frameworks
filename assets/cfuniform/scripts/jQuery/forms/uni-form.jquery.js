...
$(document).ready(function() {
	...
	var dateOptions = {
		...
		buttonImage:'/assets/cfuniform/images/uni-form/calendar.png',
	...
	try { // try to set the timeentry defaults (Keith Wood)
		jQuery.timeEntry.setDefaults({
			show24Hours:false,
		 	spinnerImage:'/assets/cfuniform/images/timeentry/spinnerDefault.png'
		});
	} catch (e3) {}
	try { // try to set the timepicker defaults (jQuery UI)
		jQuery.timepicker.setDefaults({
			...
			buttonImage:"/assets/cfuniform/images/uni-form/clock.png",
			buttonImageOnly:true
		});
	} catch (e2) {}
});